            ...
            <div class="search-results">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['searchType']) && isset($_GET['searchQuery'])) {
                    ...
                    if ($searchType == 'agent') {
                        ...
                        $sql = "SELECT * FROM Agent WHERE Specialite LIKE '%$searchQuery%'";
                    }
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            if ($searchType == 'agent' || $searchType == 'speciality') {
                                echo "<li>Agent : " . $row['Nom'] . " " . $row['Prenom'] . " - Spécialité : " . $row['Specialite'] . " - Email : " . $row['Email'] . "</li>";
